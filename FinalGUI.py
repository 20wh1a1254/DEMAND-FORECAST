...
model = joblib.load("/home/susmitha/Desktop/MLProject/xgbmodel_model.joblib")
...
def main():
    ...
    def values(): 
        ...
        Prediction_result  = ("Predicted Sales:",predict_sales(date1,store1,item1))
        label_Prediction = Label(root, text= Prediction_result, bg='salmon')
        canvas1.create_window(445, 170, window=label_Prediction)

    button1 = Button (root, text='Predict Sales',command=values, bg='lightgreen') # button to call the 'values' command above 
